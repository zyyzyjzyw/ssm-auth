...
import com.tedu.java.utils.IpUtil;
import com.tedu.java.utils.JwtHelper;
import com.tedu.java.utils.ResponseUtil;
 ...
 * @description： TODO
 * @version: 1.0
 * @描述：登录过滤器，继承UsernamePasswordAuthenticationFilter，对用户名密码进行登录校验
 **/
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        //认证成功后，记录信息
        sysLoginLogService.recordLoginLog(customUser.getUsername(),1, IpUtil.getIpAddress(request),"登陆成功");
